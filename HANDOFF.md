# 接手入口：OpenScope Android 本地开发版 0.4.4

**2026-09-23 覆盖安装版：**0.4.4 使用 `versionCode=8`、`versionName=0.4.4`，保留 0.4.3 的功能并修复极简首页 dock、深色文字和状态栏对比度。详见 [docs/release-0.4.4.md](docs/release-0.4.4.md)。
