...
| 关键词 | App 内结果 | 耗时 | 观察 |
| --- | ---: | ---: | --- |
| `iPhone` | 16 条 | 6185ms | 前两条标题均与 iPhone 相关，卡片展示封面、作者与点赞数。见 [截图](../artifacts/douyin-iphone-result.png)。 |
...
`pwsh -File .\scripts\build-local.ps1 -Target Verify` 成功，耗时 1m57s，56 项 JVM 单测通过（0 失败、0 错误），lint 0 error / 31 warnings。见 [完整日志](../artifacts/build-0.4.2-verify.log)。

| ABI | 本地包 | 大小 | SHA-256 |
| --- | --- | ---: | --- |
| ARM64 真机 | [OpenScope-0.4.2-arm64-v8a.apk](../artifacts/OpenScope-0.4.2-arm64-v8a.apk) | 10,746,951 bytes | `97DDB1D39E5A535E616EC212E9D250193FB163BDED105AC5D05EAE243D0DA199` |
| x86_64 模拟器 | [OpenScope-0.4.2-x86_64.apk](../artifacts/OpenScope-0.4.2-x86_64.apk) | 11,440,785 bytes | `3F2A83B461A8588859482F0AD3E00A9246FF906FB36CA813F0FEF913100AB9FD` |
