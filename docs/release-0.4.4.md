...
本版本使用与 0.4.3 相同的内部测试签名，仅用于本地侧载测试；未作为 GitHub Release 发布。
...
| 本地 APK | 字节数 | SHA-256 |
| --- | ---: | --- |
| `artifacts/OpenScope-0.4.4-arm64-v8a.apk` | 10,764,663 | `5B4894EE13E52C538E5B7785CD3EAC2B1A04BBF08CD00BD25BFA3DA63DD29A63` |
| `artifacts/OpenScope-0.4.4-x86_64.apk` | 11,458,497 | `EA18E3D6EAEF735AA0B427897F7DB96A7EE939A16B18D86693578F555F1D71C8` |
