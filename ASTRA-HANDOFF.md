...
**2026-09-23 当前入口：**项目目录 `D:\OpenScope`；GitHub 仓库现名为 [metaMMY07/OpenScope](https://github.com/metaMMY07/OpenScope)，0.4.4 已发布（版本代码 8，可覆盖 0.4.3）。源码位于 `codex/siye-android-parity`，最新验收见 [docs/release-0.4.4.md](docs/release-0.4.4.md)，SiYe 功能对照见 [docs/release-0.4.0.md](docs/release-0.4.0.md)。下文保留迁移和旧版发布时的历史记录。
